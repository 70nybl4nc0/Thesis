...
\subsubsection{The bica cognitive decathlon}
...
Otro ejemplo similar, \textbf{Obstacle Tower} (\cite{juliani2019obstacle}) es un nuevo juego en 3D basado en la venganza de Moctezuma \ref{fig:tower}, uno de los juegos Atari más difíciles (para la IA), cuyas fases se generan de forma procedural. 
