...
\title{Evaluación de modelos de aprendizaje
reforzado en tareas cognitivas de
propósito general}
\author{\\\vspace{0.25cm}Tony Raúl Blanco Fernández}
\advisor{\\\vspace{0.25cm}Dr. Alejandro Piad Morffis}
\degree{Licenciado en (Matemática o Ciencia de la Computación)}
\faculty{Facultad de Matemática y Computación}
\date{15 de Septiempre del 2022 \\\vspace{0.25cm}\href{https://github.com/70nybl4nc0/thesis}{github.com/70nybl4nc0/thesis}}
